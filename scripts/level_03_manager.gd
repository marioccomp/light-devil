...
func _ready() -> void:
	...
	complete_label.text = "Jogo concluído!"
	repeat_tutorial_button.text = "Repetir fase"
	quit_button.text = "Sair do jogo"
	next_phase_button.visible = false
...
func _start_level() -> void:
	...
	var intro_key := "level_03_intro_already_played"
...
func complete_phase() -> void:
	...
	print("Fase 3 concluída! Jogo finalizado")
